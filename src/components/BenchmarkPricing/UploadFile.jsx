...
import { updateFileUploadBtn } from '../../redux/Benchmark';
import { Box, Button, DialogActions, DialogContent, DialogContentText, Divider, Typography } from '@mui/material';
...
function SimpleDialog(props) {
    ...
    return (
        <Dialog
            ...
            <DialogContent>
                <Box sx={{ width: { xs: "auto", md: "502px" } }} {...getRootProps({ className: `dropzone ${isDragActive ? 'dropzone-active' : ''}` })}>
                    <input {...getInputProps()} />
